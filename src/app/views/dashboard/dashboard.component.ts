...
@Component({
  ...
  providers: [ Slots ],
  styles:[`
    .coins-div {     border: 1px solid #FDEA02; background: white; border-radius: 5px; } 
    .10-coins-div{ background:#511316;}
    .img-cont { padding:15px; }  
    .coin-img { height:75px; float:left; }
    .quiz-title { width: 68%; float: left;padding-top: 11px;font-weight: bold;font-size: 24px; }
    .quiz-info {    display: inline-block;    font-size: 16px; }
    .title-cont { text-align: center }
  `]
})
export class DashboardComponent implements OnInit {
  ...
  quizStat(quiz, date?){
    ...
    this.spinner.show();
    this.service.getQuiz(quiz,date)
    .subscribe(_response => {
